 ...
 * @returns {object}
 */
export function openingPosition(save, data, { rosterCodes } = {}) {
  ...
  return createInitialState({
    ...
    seed: save.seed,
    data,
    rosterCodes: save.rosterCodes ?? rosterCodes,
  });
}
 ...
 */
export function replay(save, data, { rosterCodes } = {}) {
  let state = openingPosition(save, data, { rosterCodes });
  const refused = [];
